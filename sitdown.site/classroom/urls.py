...
urlpatterns = [
    ...
    path(
        "classroom/<str:slug>/", ClassroomDetailView.as_view(), name="classroom_detail"
    ),
    ...
    path(
        "schoolboy_detail/<str:slug>/",
        SchoolboyDetailView.as_view(),
        name="schoolboy_detail",
    ),
    path(
        "schoolboy_update/<str:slug>/",
        SchoolboyUpdate.as_view(),
        name="schoolboy_update",
    ),
    path(
        "schoolboy_delete/<str:slug>/",
        SchoolboyDelete.as_view(),
        name="schoolboy_delete",
    ),
    ...
    path(
        "boy_location_update/<str:slug>/",
        boy_location_update,
        name="boy_location_update",
    ),
