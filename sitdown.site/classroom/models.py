...
class Schoolboy(models.Model):
    ...
    classroom = models.ForeignKey(
        Classroom, related_name="schoolboy", on_delete=models.CASCADE
    )
    gender = models.ForeignKey(
        Gender, related_name="schoolboy", on_delete=models.CASCADE
    )
    requirement = models.ForeignKey(
        Requirement, related_name="schoolboy", on_delete=models.CASCADE
    )
...
class Location(models.Model):
    ...
    classroom = models.ForeignKey(
        Classroom, related_name="location", on_delete=models.CASCADE
    )
...
class Teacher(models.Model):
    ...
    position = models.CharField(
        "Должность", max_length=255, default="Классный руководитель"
    )
    slug = models.SlugField(max_length=255, unique=True)
    classroom = models.ForeignKey(
        Classroom, related_name="teacher", on_delete=models.CASCADE
    )
